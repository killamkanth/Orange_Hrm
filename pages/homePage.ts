...
export class HomePage{
    ...
    async generateRandomString(length: number) {
      ...
      async generatePathForTableElement(text :string){
         this.page.locator(`//div[div[text()="${text}"]]`)
      }
    ...
    async generatePathForDeleteIcon(jobName:string) {
      let ele =  this.page.locator(`//div[div[text()='${jobName}']]/following-sibling::div//button[i[@class='oxd-icon bi-trash']]`)
      return ele;
    }

    async generatePathForEditIcon(jobName:string) {
      let ele =  this.page.locator(`//div[div[text()='${jobName}']]/following-sibling::div//button[i[@class='oxd-icon bi-pencil-fill']]`)
      return ele;
    }
    ...
    async verifyJobTitleRecordTable(jobName:string){
      ...
      console.log(jobTitleArray , jobTitleArray.length);
      console.log(jobTitleArray.length);
      let boo = jobTitleArray.includes(jobName);
      return boo;
    }
    ...
    async generatePathForCheckBoxElement(jobName:string) {
      let ele =  this.page.locator(`//div[div[text()='${jobName}']]/preceding-sibling::div//label`)
      return ele;
    }
  ...
  async clickOnButton(buttonName : string){
    const btn =  this.page.locator(`//button[normalize-space()='${buttonName}']`)
    btn.click();
  }
